...
<!--
  Relocated from .specify/memory/constitution.md on 2026-06-10 when the
  spec-kit scaffolding was retired (the project consolidated on the
  superpowers planning format on 2026-05-24). Content unchanged; a
  re-ratification pass to align quality-gate claims with the actual CI
  gates is planned (see docs/superpowers/plans/2026-06-10-dev-workflow-sota.md).
-->
