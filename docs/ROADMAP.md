...
- [ ] **Provider flexibility (BYOK)** — design + ship the Bring-Your-Own-Key flow with audit + per-user rate limits. Slice 1 (provider registry) — see docs/superpowers/plans/2026-09-12-llm-provider-registry-slice1.md. Slice 2 (connections + per-user engine) — see docs/superpowers/plans/2026-09-12-llm-provider-registry-slice2.md; audit + rate limits remain.
