-- =====================================================
-- MIGRATION: Refatorar Template CHARMS com Hierarquia
-- =====================================================
-- Descrição: Reestrutura o template CHARMS seguindo o 
-- checklist oficial com hierarquia Study → Models
-- =====================================================

-- 1. Deletar template antigo (não há dados em produção)
DELETE FROM extraction_fields WHERE entity_type_id IN (
  SELECT id FROM extraction_entity_types WHERE template_id = (
    SELECT id FROM extraction_templates WHERE name = 'CHARMS'
  )
);
DELETE FROM extraction_entity_types WHERE template_id = (
  SELECT id FROM extraction_templates WHERE name = 'CHARMS'
);
DELETE FROM extraction_templates WHERE name = 'CHARMS';

-- 2. Criar novo template CHARMS com hierarquia
DO $$
DECLARE
  charms_id UUID;
...
BEGIN
  -- Inserir template
  INSERT INTO extraction_templates (name, description, framework, version, is_global, schema)
  VALUES (
    'CHARMS',
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'source_of_data', 'Source of Data', 
  ...
  INSERT INTO extraction_fields (entity_type_id, name, label, field_type, is_required, sort_order) VALUES
    (source_data_id, 'data_source', 'Source of data', 'select', true, 1),
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'participants', 'Participants',
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'outcome', 'Outcome to be Predicted',
  ...
  INSERT INTO extraction_fields (entity_type_id, name, label, field_type, is_required, sort_order) VALUES
    ...
    (outcome_id, 'type_of_outcome', 'Type of outcome', 'select', true, 4),
    (outcome_id, 'outcome_assessed_blinded', 'Was the outcome assessed without knowledge of predictors?', 'select', false, 5),
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'sample_size', 'Sample Size',
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'missing_data', 'Missing Data',
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'prediction_models', 'Prediction Models',
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'candidate_predictors', 'Candidate Predictors',
  ...
  INSERT INTO extraction_fields (entity_type_id, name, label, field_type, is_required, sort_order) VALUES
    ...
    (candidate_predictors_id, 'predictors_assessed_blinded', 'Were predictors assessed blinded?', 'select', false, 5),
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'final_predictors', 'Final Predictors',
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'model_development', 'Model Development',
  ...
  INSERT INTO extraction_fields (entity_type_id, name, label, field_type, is_required, sort_order) VALUES
    ...
    (model_development_id, 'shrinkage', 'Shrinkage of weights or coefficients', 'select', false, 4);

  -- 6.4. Model Performance (CHILD de prediction_models)
  INSERT INTO extraction_entity_types (
    template_id, name, label, description, cardinality, parent_entity_type_id, sort_order
  ) VALUES (
    charms_id, 'model_performance', 'Model Performance',
  ...
  INSERT INTO extraction_entity_types (
    ...
    charms_id, 'model_validation', 'Model Validation',
    'Validation methods used', 'one', prediction_models_id, 5
  ) RETURNING id INTO model_validation_id;
  
  INSERT INTO extraction_fields (entity_type_id, name, label, field_type, is_required, sort_order) VALUES
    (model_validation_id, 'internal_validation', 'Internal validation', 'select', false, 1),
    (model_validation_id, 'external_validation', 'External validation', 'select', false, 2),
    (model_validation_id, 'model_adjusted', 'Model adjusted after poor validation?', 'boolean', false, 3);

  -- Log de sucesso
  RAISE NOTICE 'Template CHARMS 2.0 criado com sucesso com hierarquia Study → Models';
  RAISE NOTICE 'Study-level entities: 5';
  RAISE NOTICE 'Model-level parent: 1 (prediction_models)';
  RAISE NOTICE 'Model-level children: 5 (candidate_predictors, final_predictors, model_development, model_performance, model_validation)';
