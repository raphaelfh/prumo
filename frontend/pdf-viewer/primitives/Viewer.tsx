...
function Page({
  ...
  // the page-sync observer above would drift. `auto` keeps the real rendered
  // size once the page has been on screen; a visible page still sizes to its
  // content, so nothing is ever clipped.
