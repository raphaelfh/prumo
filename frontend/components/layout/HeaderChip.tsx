...
export const headerChip = cva(
  'inline-flex h-7 items-center gap-1.5 rounded-md border border-border/50 px-2 text-header-meta text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring [@media(pointer:coarse)]:h-11',
  {
    variants: {
      interactive: {
