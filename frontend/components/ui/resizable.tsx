...
// Separator renders aria-orientation per WAI-ARIA: a divider between
// side-by-side panels (horizontal group) is aria-orientation="vertical",
// so the horizontal-group styles are the default and the vertical-group
// overrides key off aria-[orientation=horizontal].
