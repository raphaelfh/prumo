...
export const extraction = {
    ...
    reviewRedoDecision: 'Redo latest undone decision',
    reviewNoRedoDecision: 'No undone decision to redo.',
    reviewRedoTarget: 'Redo applies to {{question}}.',
    ...
    reviewSourcesCountOne: '{{n}} source',
    reviewSourcesCountOther: '{{n}} sources',
