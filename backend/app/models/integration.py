...
Modelos for integracoes externas como Zotero.
"""
...
class ZoteroIntegration(BaseModel):
    """
    Integracao Zotero por user.

    API keys sao criptografadas with Fernet (key derivada do user_id).
    """
    ...
    library_type: Mapped[str] = mapped_column(Text, nullable=False)  # 'user' or 'group'
